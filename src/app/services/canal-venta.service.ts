...
export class CanalVentaService {
  ...
  public getAll() {
    return this.http.get<CanalVentaJVDTO[]>(`${this.endpointGetAllCanalVenta}`, {});
  }

  public create(canalVenta: CanalVentaJVDTO) {
    return this.http.post<CanalVentaJVDTO>(`${this.endpointCreateCanalVenta}`, canalVenta);
  }

  public update(canalVenta: CanalVentaJVDTO) {
    return this.http.patch<CanalVentaJVDTO>(`${this.endpointUpdateCanalVenta}`, canalVenta);
  }

  public habilitar(canalVentaId: number) {
    return this.http.patch<any>(`${this.endpointHabilitarCanalVenta}/${canalVentaId}`, {});
  }

  public inhabilitar(canalVentaId: number) {
    return this.http.patch<any>(`${this.endpointInhabilitarCanalVenta}/${canalVentaId}`, {});
  }
}
